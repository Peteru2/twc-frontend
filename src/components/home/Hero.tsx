        ...
        <div className="relative z-10 text-center">
          ...
          >
            ...
            <span className="text-[#E80F1A]">
              ...
              <motion.span
                variants={childVariants}
                className="inline-block md:ml-8"
              >
                Christ
              </motion.span>
            </span>
          ...
          >
            ...
            <b className="text-[#E80F1A]"> Receive Christ</b> And Disciple the
            Church to
          ...
          <div className="flex flex-col items-center justify-center md:flex-row lora mt-20 gap-4">
            <Link
              to={"https://www.youtube.com/@TrueWorshippersChurch"}
              target="_blank"
            >
          ...
          <div className="flex  justify-center text-white mt-20">
            <div>
              ...
              <h3 className="tracking-widest text-left text-[14px]">
                SCROLL DOWN
              </h3>
            </div>
          </div>
