  ...
  return (
    <div className="w-full lato ">
      ...
      <div className="bg-[#E80F1A] overflow-hidden relative lg:py-36 py-16">
        ...
        >
          <h1 className="md:text-4xl text-2xl viga ">Partner in the Vision</h1>

          <div className="py-4">
            Every gift helps us evangelize, disciple, and serve with
            excellence.Together, we are raising true worshippers and
            transforming lives.
          </div>
